...
@Table(name = "tb_if_order_label", idStrategy = GenerationRule.UUID, uniqueFields = "domainId,ifOrderId", indexes = {
	@Index(name = "tb_if_order_label_0", columnList = "if_order_id", unique = true)
})
public class JobOrderLabel extends xyz.elidom.orm.entity.basic.ElidomStampHook {
	/**
	 * SerialVersion UID
	 */
	private static final long serialVersionUID = 185050568469286430L;

	@PrimaryKey
	@Column (name = "id", nullable = false, length = 40)
	private String id;

	@Column (name = "if_order_id", nullable = false, length = 40)
	private String ifOrderId;
	...
	@Column (name = "rcv_zip_cd", length = 50)
	...
	@Column (name = "snd_tel_no", length = 100)
	...
	@Column (name = "dlv_memo", length = 255)
	...
	public String getIfOrderId() {
		return ifOrderId;
	}

	public void setIfOrderId(String ifOrderId) {
