...
public class StageIndConfigUtil {
	 ...
	 * @return
	 */
	public static int getIndOnDelayTime(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static int getIndOnDelayTimeCancelPushed(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static boolean isNoackWhenAlreadyOffEnabled(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getDisplayStringBeforeIndOn(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static int getDisplayIntervalBeforeIndOn(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static int getIndStateReportInterval(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String[] getIndButtonColorForRotation(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getIndColorForStocktaking(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static int getSegmentCount(String stageCd, String indType) {
		return getSegmentRoles(stageCd, indType).length;
	}
	 ...
	 * @return
	 */
	public static String[] getSegmentRoles(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getSegment1RoleForDisplay(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getSegment2RoleForDisplay(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getSegment3RoleForDisplay(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getMaxRelayNo(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getButtonBlinkInterval(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getButtonOnMode(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static boolean isFullButtonBlink(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getShowViewType(String stageCd, String indType) {
		// ind.show.view-type
		return null;
	}
	 ...
	 * @return
	 */
	public static String getShowNumberAlignment(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static int getLedBlinkInterval(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static int getLedBrightness(String stageCd, String indType) {
		// ind.led.brightness						
		return 0;
	}
	 ...
	 * @return
	 */
	public static boolean isLedBlink(String stageCd, String indType) {
		// ind.show.fullbox.button.blink
		return false;
	}
	 ...
	 * @return
	 */
	public static boolean isUseLed(String stageCd, String indType) {
		// ind.led.use.enabled						
		return false;
	}
	 ...
	 * @return
	 */
	public static String[] getRackOfUsingLed(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static boolean isUseButton(String stageCd, String indType) {
		// ind.buttons.enable							
		return false;
	}
	 ...
	 * @return
	 */
	public static boolean getIndLatestReleaseVersion(String stageCd, String indType) {
	 ...
	 * @return
	 */
	public static String getGwLatestReleaseVersion(String stageCd, String indType) {
